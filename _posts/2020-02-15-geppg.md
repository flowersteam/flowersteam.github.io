...
summary: 'Deep RL suffers from inefficient exploration in sparse-reward settings. We decouple exploration and exploitation: diversity search collects varied trajectories, then deep RL bootstraps from them.'
categories: jekyll
permalink: bootstraping_rl_with_diversity
use_math: true
tags: [machine-autotelic-learning, deep-RL, exploration, diversity-search, reinforcement-learning]
authors: 
  - name: 'Cédric Colas'
