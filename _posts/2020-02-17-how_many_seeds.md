...
summary: A statistical guide for rigorous comparison of deep RL algorithms, addressing the reproducibility crisis through principled random seed usage and statistical testing.
categories: jekyll
permalink: how_many_random_seeds
use_math: true
tags: [machine-autotelic-learning, reproducibility, statistics, deep-RL]
authors: 
  - name: 'Cédric Colas'
