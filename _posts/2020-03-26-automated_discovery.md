...
summary: We automate discovery of diverse self-organized patterns in complex systems. Intrinsically-motivated goal exploration on a continuous Game of Life reveals a rich variety of emergent structures.

categories: jekyll
permalink: intrinsically_motivated_discovery_of_diverse_patterns
thumbnail: /media/gif/lenia.gif
use_math: true
tags: [assisted-scientific-discovery, self-organization, intrinsic-motivation, discovery, cellular-automata]
authors: 
