...
date:       2025-02-06
summary: LLMs struggle to connect words to real-world concepts. We propose functional grounding via reinforcement learning in interactive environments, and demonstrate it with GLAM on BabyAI-Text.

categories: jekyll
permalink: glam
thumbnail: /images/posts/2025-02-06-glam/robot.png
use_math: true
tags: [machine-autotelic-learning, language-models, grounding, reinforcement-learning, interactive-learning]
authors: 
- name: 'Clément Romac'
