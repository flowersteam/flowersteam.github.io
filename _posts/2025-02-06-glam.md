...
<i>Illustration of an anaconda in a shopping mall. Generated with FLUX.1[dev]</i></sub>
</div>
</div>
...
<div>
<sub style="display: block; line-height: 1.5em">
<i>A robot performing experiments. Generated with FLUX.1[dev].</i></sub>
</div>
</div>
...
In July 2023, we introduced ["Grounding Large Language Models in Interactive Environments with Online Reinforcement Learning"](https://sites.google.com/view/grounding-llms-with-online-rl/) (aka GLAM). In this paper, we proposed the first approach to functionally ground LLMs. 
...
@misc{romac_can_2025,
	title = {Can {AIs} understand our world? {Functionally} grounding {LLMs} in interactive environments.},
	shorttitle = {Can {AIs} understand our world?},
	url = {http://flowersteam.github.io/glam},
	abstract = {Developmental Systems, a Blog of the Flowers Lab},
	language = {en},
	urldate = {2025-04-27},
	journal = {Developmental Systems, a Blog of the Flowers Lab},
	author = {Team, INRIA Flowers},
}
