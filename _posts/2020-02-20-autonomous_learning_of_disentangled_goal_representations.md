...
summary: How can an agent autonomously discover and learn to represent its own goals? We explore developmental learning for open-ended multi-task acquisition without human-defined objectives.

categories: jekyll
permalink: autonomous_learning_of_disentangled_goal_representations
use_math: true
tags: [machine-autotelic-learning, intrinsic-motivation, goal-learning, developmental-learning, reinforcement-learning]
authors: 
